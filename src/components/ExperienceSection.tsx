import { EXPERIENCE_ITEMS } from '../utils/constant';
  ...
  return (
    <section className="py-20 px-6 md:px-12 max-w-screen-2xl mx-auto" id="experience">
      <div className="mb-20 text-center">
        <p className="text-primary font-semibold tracking-[0.2em] uppercase text-xs mb-4">Professional Journey</p>
        ...
        <p className="mt-6 text-on-surface-variant max-w-2xl mx-auto text-lg">
          A journey through full-stack development, from building responsive interfaces to architecting scalable backend systems.
        </p>
      </div>
